package com.common.springboot.web.configuration;
...
@Aspect
@Configuration
@MapperScan(value="com.common.springboot.web.mapper") // 扫描操作表方法对应的接口文件路径
public class ApplicationContextTransactional {

	// 事务方法超时时间设置
	private static final int TX_METHOD_TIMEOUT = 5;
	// AOP切面的切点表达式, 在controller层提交事务
    private static final String AOP_POINTCUT_EXPRESSION = "execution(* com.common.springboot.web.controller..*.*(..))";
    // AOP切面的切点表达式, 在service层提交事务
    //private static final String AOP_POINTCUT_EXPRESSION = "execution(* com.common.springboot.web.service*..*.*(..))";
    // 注入事务管理器
    @Autowired
